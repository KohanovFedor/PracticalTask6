...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="ClientsE.aspx.cs" Inherits="IIS.Product_51172.ClientsE" %>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlFIOLabel" runat="server" Text="ФИО клиента" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlFIO" runat="server">
</asp:TextBox>

<asp:RequiredFieldValidator ID="ctrlFIORequiredFieldValidator" runat="server" ControlToValidate="ctrlFIO"
                            ErrorMessage="Не указано: FIO" Text="*" 
                            EnableClientScript="true" ValidationGroup="savedoc" />

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlaccountLabel" runat="server" Text="Лицевой счет" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlaccount" Type="Numeric" runat="server">
</ac:AlphaNumericTextBox>

<asp:RequiredFieldValidator ID="ctrlaccountRequiredFieldValidator" runat="server" ControlToValidate="ctrlaccount"
                            ErrorMessage="Не указано: account" Text="*" 
                            EnableClientScript="true" ValidationGroup="savedoc" />
