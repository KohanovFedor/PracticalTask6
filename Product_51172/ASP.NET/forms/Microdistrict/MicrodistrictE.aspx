...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="MicrodistrictE.aspx.cs" Inherits="IIS.Product_51172.MicrodistrictE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass + " " +  Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass + " " + Constants.EditFormHeaderCssClass %>">Микрорайоны</h2>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlNameMicrodistrictLabel" runat="server" Text="Названия микрорайона" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlNameMicrodistrict" runat="server">
</asp:TextBox>

<asp:RequiredFieldValidator ID="ctrlNameMicrodistrictRequiredFieldValidator" runat="server" ControlToValidate="ctrlNameMicrodistrict"
                            ErrorMessage="Не указано: NameMicrodistrict" Text="*" 
